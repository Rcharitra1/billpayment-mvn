 ...
 *
 * @Comments
 * This interceptor class for bills. This enables protection on method level should the url moves to another
...
public class BillSecurityInterceptor {
    ...
    public Object verifyAccess(InvocationContext ic) throws Exception {
        ...
        if (methodName.toLowerCase().startsWith("create") || methodName.toLowerCase().startsWith("find") ||

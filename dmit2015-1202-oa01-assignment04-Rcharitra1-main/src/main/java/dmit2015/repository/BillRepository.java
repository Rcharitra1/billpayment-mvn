 ...
 *
 * @Comments
 * Added interceptor to deny unauthorized users access to the repository methods
 *
 * */
@ApplicationScoped
@Transactional
...
public class BillRepository {
    ...
    public List<Bill> findAll() {
        ...
        {
            String username = _securityContext.getCallerPrincipal().getName();
            queryResultList = _entityManager.createQuery("SELECT b FROM Bill b WHERE b.username= :usernameValue", Bill.class).setParameter("usernameValue", username)
                    .getResultList();
        }
